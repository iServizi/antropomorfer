...
- **Integracja z modelem AI** — komunikacja z zewnętrznym modelem OpenAI `gpt-image-1` (image + prompt to image), ktory zostal uzyty w zdefiniowany narzedziu w celu transformacji zwierzecia na czlowieka, na podstawie zaladowanego zdjecia oraz z wykorzystaniem rozbudowanego promptingu - definicja narzedzia **animal_transformer.py**
- **Integracja z modelem AI** — komunikacja z zewnętrznym modelem `gemini-flash-lite-latest`, ktory zostal uzyty w zdefiniowanym narzedziu w celu rozpoznania zwierzecia na zaladowanym zdjeciu - definicja narzedzia **image_tools.py**
